<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:112:"D:\phpStudy\PHPTutorial\WWW\eat-easy-background\public/../application/admin\view\profit_manage\profit-chart.html";i:1558155400;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	...
	$(function () {
		...
		*/
		...
		参数: 
			...
			textArr: 数轴上的点的文字
		*/
		function drawLineChart(ctx, arr, textArr) {
			// 获取当前cvs的宽高
			...
			arr.forEach(function (value, index) {
				...
				// 画点
				ctx.beginPath();
				ctx.arc(coordX, coordY, 3, 0, 2 * Math.PI);
				ctx.fill();
		...
		// 读取服务器的json数据
		var resultObj = <?php echo $profitJson; ?>;
		// console.log(typeof resultJson); // 伪数组
		...
		for(var key in resultObj) {
			textArr.push(resultObj[key]['profit_time']);
			dataArr.push(resultObj[key]['profit']);
		}
		
		fitScreen();
		
		// 预先画一次
		drawLineChart(ctx, dataArr, textArr);
