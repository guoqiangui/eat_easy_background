<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:116:"D:\phpStudy\PHPTutorial\WWW\eat-easy-background\public/../application/merchant\view\data_analysis\data-analysis.html";i:1558921514;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
<script>
	$(function () {
		...
		*/
		...
		// 横坐标上五个点的文字
		var textArr = ["粉丝数", "阅读数", "点赞数", "转发数", "评论数"];
