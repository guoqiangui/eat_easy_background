<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:118:"D:\phpStudy\PHPTutorial\WWW\eat-easy-background\public/../application/merchant\view\content_manage\modify-article.html";i:1558880808;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	...
	<body>
		<div class="wrapper">
			...
			<div class="title-input">
				...
				<input type="text" placeholder="请输入文章标题" id="titleInput" value="<?php echo $res['title']; ?>">
			</div>
			<!-- 编辑器 -->
			...
			<div class="operate-btn-wrapper">
				<ul class="operate-btn-list">
					<li class="operate-btn-item">
						<a href="javascript:;" class="operate-btn submit">提交修改</a>
					</li>
					<li class="operate-btn-item">
...
// 	};
	...
	// 渲染文章内容给编辑器
	editor.txt.html("<?php echo $res['content']; ?>");
	
	// 点击提交修改
	$(".operate-btn.submit").on("click", function () {
		// 获得标题
		...
		$.ajax({
			url: `http://${serverName}/eat-easy-background/public/merchant/content_manage/modifyArticle`,
			type: "post",
			data: {
				id: <?php echo $id; ?>,
				title: title,
